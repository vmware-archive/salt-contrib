...
def status(url='http://localhost:8080/manager'):
    ...
    CLI Examples::
        ...
        salt '*' tomcat_manager.status
        salt '*' tomcat_manager.status http://localhost:8080/manager
    '''
...
def ls(url='http://localhost:8080/manager'):
    ...
    CLI Examples::
        ...
        salt '*' tomcat_manager.ls
        salt '*' tomcat_manager.ls http://localhost:8080/manager
    '''
...
def stop(app, url='http://localhost:8080/manager'):
    ...
    CLI Examples::
        ...
        salt '*' tomcat_manager.stop /jenkins
...
def start(app, url='http://localhost:8080/manager'):
    ...
    CLI Examples::
        ...
        salt '*' tomcat_manager.start /jenkins
...
def sessions(app, url='http://localhost:8080/manager'):
    ...
    CLI Examples::
        ...
        salt '*' tomcat_manager.sessions /jenkins
...
def status_webapp(app, url='http://localhost:8080/manager'):
    ...
    CLI Examples::
        ...
        salt '*' tomcat_manager.status_webapp /jenkins
        salt '*' tomcat_manager.status_webapp /jenkins http://localhost:8080/manager
    '''
...
def serverinfo(url='http://localhost:8080/manager'):
    ...
    CLI Examples::
        ...
        salt '*' tomcat_manager.serverinfo
        salt '*' tomcat_manager.serverinfo http://localhost:8080/manager
    '''
...
def deploy_war(war, context, force='no', url='http://localhost:8080/manager', env='base'):
    ...
    CLI Examples::
        ...
        cp module
        salt '*' tomcat_manager.deploy_war salt://application.war /api
        salt '*' tomcat_manager.deploy_war salt://tmp/application.war /api no
        salt '*' tomcat_manager.deploy_war salt://tmp/application.war /api yes http://localhost:8080/manager
        
        minion local file system
        salt '*' tomcat_manager.deploy_war /tmp/application.war /api
        salt '*' tomcat_manager.deploy_war /tmp/application.war /api no
        salt '*' tomcat_manager.deploy_war /tmp/application.war /api yes http://localhost:8080/manager
    '''
